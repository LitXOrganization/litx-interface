            ...
            <Card classes={"br-24 p-2 mm_p-1"}>
                ...
                <Switch>
                    ...
                    <Route exact path={`${path}/farms`}>
                        <Helmet>
                            <title>{t`LitX — Farming • My Farms`}</title>
                        </Helmet>
                        {account ? (
                            <>
                    ...
                    {/* <Route exact path={`${path}/limit-farms`}>
                        <Helmet>
                            <title>{t`LitX — Farming • Limit Farms`}</title>
                        </Helmet>
                    ...
                    <Route exact path={`${path}/infinite-farms`}>
                        <Helmet>
                            <title>{t`LitX — Farming • Infinite Farms`}</title>
                        </Helmet>
                    ...
                    {/* <Route exact strict path={`${path}/farms-history`}>
                        <Helmet>
                            <title>{t`LitX — Farming • Farms History history`}</title>
                        </Helmet>
                        <EventsHistory />
                    </Route> */}
                </Switch>
