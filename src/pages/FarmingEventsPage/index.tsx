        ...
        <div className={"w-100"}>
            ...
            {refreshing ? (
                <div className={"farmings-page__loader f f-ac f-jc"}>
                    <Loader stroke={"var(--loader)"} size={"1.5rem"} />
                </div>
                ...
                <div className={"farmings-page__row mb-1 rg-1 cg-1 "}>
                    {formattedData.map((event, j) => {
                        ...
                        const active = isStarted && !isEnded && new Date(+event.enterStartTime * 1000).getTime() < Date.now();
                ...
                Date.now() < 1651244400000 ? (
                    ...
                    <div className={"farmings-page__loader f c f-ac f-jc"}>
                        <Frown size={35} stroke={"var(--icon)"} className={"mb-1"} />
                        <div>
