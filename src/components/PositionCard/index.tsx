                ...
                {showMore && (
                    <AutoColumn gap="8px">
                        ...
                        <FixedHeightRow>
                            ...
                            <Text fontSize={16} fontWeight={500}>
                                {poolTokenPercentage ? <Trans>{poolTokenPercentage.toFixed(2) === "0.00" ? "<0.01" : poolTokenPercentage.toFixed(2)} %</Trans> : "-"}
                            </Text>
                        </FixedHeightRow>
                        {userDefaultPoolBalance && JSBI.greaterThan(userDefaultPoolBalance.quotient, BIG_INT_ZERO) && (
                            <RowBetween marginTop="10px">
                                ...
                                <ButtonPrimary
                                    ...
                                    $borderRadius="8px"
                                    as={Link}
                                    to={`/add/${currencyId(currency0, chainId || AlgebraConfig.CHAIN_PARAMS[chainId || 56].chainId)}/${currencyId(
                                        currency1,
                                        chainId || AlgebraConfig.CHAIN_PARAMS[chainId || 56].chainId
                                    )}`}
                                    width="32%"
                                >
                                    <Trans>Add</Trans>
                        ...
                        {stakedBalance && JSBI.greaterThan(stakedBalance.quotient, BIG_INT_ZERO) && (
                            <ButtonPrimary
                                ...
                                $borderRadius="8px"
                                as={Link}
                                to={`/uni/${currencyId(currency0, chainId || AlgebraConfig.CHAIN_PARAMS[chainId || 56].chainId)}/${currencyId(
                                    currency1,
                                    chainId || AlgebraConfig.CHAIN_PARAMS[chainId || 56].chainId
                                )}`}
                                width="100%"
