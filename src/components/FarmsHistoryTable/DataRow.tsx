        ...
        <div>
            <ResponsiveGrid style={{ borderBottom: "1px solid rgba(225, 229, 239, 0.18)", paddingBottom: "1rem" }}>
                ...
                <LabelStyled fontWeight={400}>
                    <div>
                        <CurrencyLogo size="35px" currency={new Token(AlgebraConfig.CHAIN_PARAMS[chainId || 56].chainId, eventData.pool.token0.address, 18) as WrappedCurrency} />
                        <CurrencyLogo
                            size="35px"
                            style={{ marginLeft: "-10px" }}
                            currency={new Token(AlgebraConfig.CHAIN_PARAMS[chainId || 56].chainId, eventData.pool.token1.address, 18) as WrappedCurrency}
                        />
                    </div>
                ...
                <LabelStyled end={1} fontWeight={400}>
                    <CurrencyLogo
                        size="35px"
                        currency={new Token(AlgebraConfig.CHAIN_PARAMS[chainId || 56].chainId, eventData.rewardToken.address, 18, eventData.rewardToken.symbol) as WrappedCurrency}
                    />
                    <div style={{ marginLeft: "10px" }}>
                ...
                <LabelStyled end={1} fontWeight={400}>
                    <CurrencyLogo
                        size="35px"
                        currency={new Token(AlgebraConfig.CHAIN_PARAMS[chainId || 56].chainId, eventData.bonusRewardToken.address, 18, eventData.bonusRewardToken.symbol) as WrappedCurrency}
                    />
                    <div style={{ marginLeft: "10px" }}>
