...
export default function StakeModalFarmingTiers({ tiersLimits, tiersMultipliers, selectTier, multiplierToken }: StakeModalFarmingTiersProps) {
    ...
    const balance = useCurrencyBalance(
        account ?? undefined,
        new Token(AlgebraConfig.CHAIN_PARAMS[chainId || 56].chainId, multiplierToken.id, +multiplierToken.decimals, multiplierToken.symbol, multiplierToken.name) ?? undefined
    );
                ...
                <div>
                    <div className="f">
                        <CurrencyLogo
                            currency={
                                new Token(
                                    AlgebraConfig.CHAIN_PARAMS[chainId || 56].chainId,
                                    multiplierToken.id,
