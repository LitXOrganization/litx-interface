...
interface FarmingCenterInterface extends ethers.utils.Interface {
  functions: {
    ...
    "connectVirtualPool(address,address)": FunctionFragment;
    "cross(int24,bool)": FunctionFragment;
    "deposits(uint256)": FunctionFragment;
    "enterFarming((address,address,address,uint256,uint256),uint256,uint256,bool)": FunctionFragment;
    "eternalFarming()": FunctionFragment;
    "exitFarming((address,address,address,uint256,uint256),uint256,bool)": FunctionFragment;
    "farmingCenterVault()": FunctionFragment;
    "getApproved(uint256)": FunctionFragment;
    "increaseCumulative(uint32)": FunctionFragment;
    "isApprovedForAll(address,address)": FunctionFragment;
    "isIncentiveActiveInPool(address,address)": FunctionFragment;
    "l2Nfts(uint256)": FunctionFragment;
    "limitFarming()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "connectVirtualPool",
  ...
  encodeFunctionData(
    functionFragment: "farmingCenterVault",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "isIncentiveActiveInPool",
    values: [string, string]
  ): string;
  encodeFunctionData(
...
export class FarmingCenter extends BaseContract {
  ...
  functions: {
    ...
    deposits(
      ...
      [BigNumber, number, boolean, string] & {
        L2TokenId: BigNumber;
        numberOfFarms: number;
        inLimitFarming: boolean;
        owner: string;
      }
    >;
    ...
    farmingCenterVault(overrides?: CallOverrides): Promise<[string]>;
    ...
    limitFarming(overrides?: CallOverrides): Promise<[string]>;
    ...
    virtualPoolAddresses(
      pool: string,
      overrides?: CallOverrides
    ): Promise<[string, string] & { limitVP: string; eternalVP: string }>;
  ...
  estimateGas: {
    ...
    farmingCenterVault(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    limitFarming(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    limitFarming(overrides?: CallOverrides): Promise<PopulatedTransaction>;
